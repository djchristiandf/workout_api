...
from app import CategoriaModel, AtletaModel, CentroTreinamentoModel
...
async def query(
    ...
    atletas_out = [
        AtletaOut(
            ...
            nome=atleta.nome,
            cpf=atleta.cpf,
            centro_treinamento=AtletaOut.CentroTreinamento(
                nome=atleta.centro_treinamento.nome
            ),
            categoria=AtletaOut.Categoria(
...
async def patch(id: UUID4, db_session: DatabaseDependency,
